...
def fastapi_server():
    ...
    # Ensure the application's database tables exist before starting the server
    try:
        # Import app.db and models to create tables using the same engine
        import app.db as app_db
        import app.models as app_models
        app_models.Base.metadata.create_all(bind=app_db.engine)
    except Exception:
        # If something goes wrong creating tables, continue and let the server
        # startup surface the error so tests fail visibly.
        pass
